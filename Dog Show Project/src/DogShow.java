...
public class DogShow{
    ...
    private void randomDogs() {
        ...
        for (int i = 0; i < DEFAULT ; i++) {
            ...
            if (rand==0)
                show.add(new Poodle("Poodle "+generator.nextInt(MEDALS), generator.nextInt(9), generator.nextDouble()*DEFAULT));
            if (rand==1)
                show.add(new Poodle("Basenji "+generator.nextInt(MEDALS), generator.nextInt(9), generator.nextDouble()*DEFAULT));
            if (rand==2)
                show.add(new Poodle("Beagle "+generator.nextInt(MEDALS), generator.nextInt(9),generator.nextDouble()*DEFAULT));
            if (rand==3)
                show.add(new Poodle("Chihuahua "+generator.nextInt(MEDALS), generator.nextInt(9),generator.nextDouble()*DEFAULT));
        }
    }
